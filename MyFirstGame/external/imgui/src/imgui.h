...
namespace ImGui
{
	...
	IMGUI_API void			ImageQuad(ImTextureID user_texture_id, const ImVec2& size, float angle, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& uv2, const ImVec2& uv3);
